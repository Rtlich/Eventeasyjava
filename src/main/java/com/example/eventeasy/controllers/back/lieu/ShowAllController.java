...
public class ShowAllController implements Initializable {
    ...
    public Parent makeLieuModel(
        ...
        Parent parent = null;
        try {
            parent = FXMLLoader.load(Objects.requireNonNull(getClass().getResource(Constants.FXML_BACK_MODEL_LIEU)));
    ...
    private void ajouterLieu(ActionEvent ignored) {
        currentLieu = null;
        MainWindowController.getInstance().loadInterface(Constants.FXML_BACK_MANAGE_LIEU);
    }
