...
public class ShowAllController implements Initializable {
    ...
    public Parent makeCategoryLModel(
        ...
        Parent parent = null;
        try {
            parent = FXMLLoader.load(Objects.requireNonNull(getClass().getResource(Constants.FXML_BACK_MODEL_CATEGORY_L)));
    ...
    private void ajouterCategoryL(ActionEvent ignored) {
        ...
        MainWindowController.getInstance().loadInterface(Constants.FXML_BACK_MANAGE_CATEGORY_L);
    }
