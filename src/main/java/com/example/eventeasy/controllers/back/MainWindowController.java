...
public class MainWindowController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btnBookingLs.setTextFill(Color.WHITE);
        btnCategoryLs.setTextFill(Color.WHITE);
        btnLieus.setTextFill(Color.WHITE);
    ...
    private void afficherBookingLs(ActionEvent ignored) {
        goToLink(Constants.FXML_BACK_DISPLAY_ALL_BOOKING_L);
    ...
    private void afficherCategoryLs(ActionEvent ignored) {
        goToLink(Constants.FXML_BACK_DISPLAY_ALL_CATEGORY_L);
    ...
    private void afficherLieus(ActionEvent ignored) {
        goToLink(Constants.FXML_BACK_DISPLAY_ALL_LIEU);
