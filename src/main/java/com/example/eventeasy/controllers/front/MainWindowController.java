...
public class MainWindowController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btnPartenaires.setTextFill(COLOR_DARK);
        btnContrats.setTextFill(COLOR_DARK);
    ...
    @FXML
    private void afficherPartenaires(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_DISPLAY_ALL_PARTENAIRE);

        btnPartenaires.setTextFill(COLOR_PRIMARY);
        Animations.animateButton(btnPartenaires, COLOR_GRAY, Color.WHITE, COLOR_PRIMARY, 0, false);
    }

    @FXML
    private void afficherContrats(ActionEvent ignored) {
        goToLink(Constants.FXML_FRONT_DISPLAY_ALL_CONTRAT);

        btnContrats.setTextFill(COLOR_PRIMARY);
        Animations.animateButton(btnContrats, COLOR_GRAY, Color.WHITE, COLOR_PRIMARY, 0, false);
    }
