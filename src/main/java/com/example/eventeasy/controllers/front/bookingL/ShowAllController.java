...
public class ShowAllController implements Initializable {
    ...
    public Parent makeBookingLModel(
        ...
        Parent parent = null;
        try {
            parent = FXMLLoader.load(Objects.requireNonNull(getClass().getResource(Constants.FXML_FRONT_MODEL_BOOKING_L)));
    ...
    private void ajouterBookingL(ActionEvent ignored) {
        ...
        MainWindowController.getInstance().loadInterface(Constants.FXML_FRONT_MANAGE_BOOKING_L);
    }
