...
public class MainWindowController implements Initializable {
    ...
    @FXML
    private Button btnCategoryAllocations;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        btnCategoryAllocations.setTextFill(COLOR_GRAY);
    ...
    private void afficherAllocations(ActionEvent ignored) {
        goToLink(Constants.FXML_BACK_DISPLAY_ALL_ALLOCATION);
    ...
    @FXML
    private void afficherCategoryAllocations(ActionEvent ignored) {
        goToLink(Constants.FXML_BACK_DISPLAY_ALL_CATEGORYALLOCATION);

        btnCategoryAllocations.setTextFill(COLOR_PRIMARY);
        Animations.animateButton(btnCategoryAllocations, COLOR_GRAY, Color.WHITE, COLOR_PRIMARY, 0, false);
    }
