...
public class ManageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // Initialisation des ComboBox avec les valeurs
        ...
        if (currentEvent != null) {
            ...
            try {
                // Remplissage des champs avec les valeurs actuelles de l'événement
    ...
    private boolean controleDeSaisie() {
        ...
        if (titleTF.getText().matches(".*\\d.*")) {
            AlertUtils.makeInformation("Le titre ne doit pas contenir de chiffres");
            return false;
        }
